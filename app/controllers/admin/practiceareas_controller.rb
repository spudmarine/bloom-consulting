class Admin::PracticeareasController < ApplicationController
  ...
  private
    ...
    def practicearea_params
      params.require(:practicearea).permit(:hero_image, :hero_title, :hero_copy, :pa1_title, :pa1_copy, :pa1_image, :pa1_home_copy, :pa2_title, :pa2_copy, :pa2_image, :pa2_home_copy, :pa3_title, :pa3_copy, :pa3_image, :pa3_home_copy, :pa4_title, :pa4_copy, :pa4_image, :pa4_home_copy, :marketing_services_title, :marketing_services_copy, :sales_services_title, :sales_services_copy, :channel_services_title, :channel_services_copy, :bi_services_title, :bi_services_copy, :pm_process_groups_title, :pm_process_groups_copy, :pm_knowledge_title, :pm_knowledge_copy, :pm_deliverables_title, :pm_deliverables_copy, :bifocus_title, :bifocus_copy)
    end
end
