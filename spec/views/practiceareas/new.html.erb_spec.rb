...
describe "practiceareas/new" do
  before(:each) do
    assign(:practicearea, stub_model(Practicearea,
      :hero_image => "MyString",
      :hero_title => "MyString",
      :hero_copy => "MyText",
      :pa1_title => "MyString",
  ...
  it "renders new practicearea form" do
    render

    assert_select "form[action=?][method=?]", practiceareas_path, "post" do
