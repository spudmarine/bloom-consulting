  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved admin_page as @admin_page" do
        ...
        allow_any_instance_of(Admin::Page).to receive(:save).and_return(false)
        post :create, {:admin_page => { "name" => "invalid value" }}, valid_session
        expect(assigns(:admin_page)).to be_a_new(Admin::Page)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested admin_page" do
        ...
        expect_any_instance_of(Admin::Page).to receive(:update).with({ "name" => "MyString" })
        put :update, {:id => page.to_param, :admin_page => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the admin_page as @admin_page" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Admin::Page).to receive(:save).and_return(false)
        put :update, {:id => page.to_param, :admin_page => { "name" => "invalid value" }}, valid_session
        expect(assigns(:admin_page)).to eq(page)
      end
