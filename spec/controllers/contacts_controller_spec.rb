  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved contact as @contact" do
        ...
        post :create, {:contact => { "address" => "invalid value" }}, valid_session
        expect(assigns(:contact)).to be_a_new(Contact)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested contact" do
        ...
        expect_any_instance_of(Contact).to receive(:update).with({ "address" => "MyText" })
        put :update, {:id => contact.to_param, :contact => { "address" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the contact as @contact" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Contact).to receive(:save).and_return(false)
        put :update, {:id => contact.to_param, :contact => { "address" => "invalid value" }}, valid_session
        expect(assigns(:contact)).to eq(contact)
      end
