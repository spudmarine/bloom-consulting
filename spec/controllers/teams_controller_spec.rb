...
describe TeamsController do
  ...
  let(:valid_attributes) { { "intro_title" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved team as @team" do
        ...
        post :create, {:team => { "intro_title" => "invalid value" }}, valid_session
        expect(assigns(:team)).to be_a_new(Team)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested team" do
        ...
        expect_any_instance_of(Team).to receive(:update).with({ "intro_title" => "MyString" })
        put :update, {:id => team.to_param, :team => { "intro_title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the team as @team" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Team).to receive(:save).and_return(false)
        put :update, {:id => team.to_param, :team => { "intro_title" => "invalid value" }}, valid_session
        expect(assigns(:team)).to eq(team)
      end
